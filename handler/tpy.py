...
def cmd_handler_(arg):
    ...
    s += ("s += ('\\n'.format())\n")*int(arg[1])
    s += "return s  \n"
    s += "\bcmd_handler_list.append( cmd_handler( ''.join(['^{}',sp,expr]) , cmd_handler_ ))\n".format(arg[0])
    return s
cmd_handler_list.append( cmd_handler( ''.join(['^handler',sp,expr,sp,expr]) , cmd_handler_ ))
...
def cmd_handler_(arg):
    ...
    s += ('\b_file.close()\n'.format())
    return s
cmd_handler_list.append( cmd_handler( ''.join(['^readfile',sp,expr]) , cmd_handler_ ))
...
def cmd_handler_(arg):
    ...
    s += ('\b_file.close()\n'.format())
    return s
cmd_handler_list.append( cmd_handler( ''.join(['^writefile',sp,expr]) , cmd_handler_ ))
